	...
	public SecurityFilterChain securityFilterChain(final HttpSecurity httpSecurity) {
		return httpSecurity
			...
			.authorizeHttpRequests(requests -> requests
				.requestMatchers("/users/register", "/error", "/users/email-available", "/users/reset-password", "/css/**", "/js/**", "/bootstrap/css/*", "/bootstrap/js/*", "/jQuery/js/*", "/datatable/css/*", "/datatable/js/*", "/GoogleFonts/svg/*").permitAll()
			)
			.authorizeHttpRequests(requests -> requests
